...
#SBATCH --job-name=outcome_external   # sensible name for the job
...
#SBATCH --output=outputs/outcome_external-%A.out
#SBATCH --error=outputs/outcome_external-%A.out
...
singularity exec --nv deoxys-apr22.sif python -u outcome_external.py $1 /net/fs-1/Ngoc/hnperf/$2 --temp_folder $SCRATCH/hnperf/$2 --analysis_folder $SCRATCH/analysis/$2 ${@:3}
