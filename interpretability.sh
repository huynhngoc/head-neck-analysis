...
rm -rf $TMPDIR/ray/*
singularity exec --nv deoxys-2023-feb-fixed.sif python interpretability.py $1 $PROJECTS/ngoc/hnperf/$2 $3 --temp_folder $SCRATCH_PROJECTS/ceheads/hnperf/$2 --analysis_folder $SCRATCH_PROJECTS/ceheads/hnperf_analysis/$2  ${@:4}
